...
// of what your dream vacation destination is in .
var dreamDestination = " Miami";
...
var statement =
	" Hi, My name is" + " Tsion," + " and I can't wait to visit" + " Miami";
...
const myAnswerForExercise10 = "Miami";
// "string";
...
const C = 4;
const D = "D";
// if stetement expecting  boolyan js have thier on low that is if
//   anything  number exept 0, string, text including space
//   return true
...
// A + B * 2 + D + C / 2:
const myAnswerForExercise15 = "R" + " 2" + "D" + " 2";
("R2D2");
